    ...
    <div className="flex w-full flex-col gap-6">
      <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-yellow-500/10 border border-yellow-500/30">
        ...
        <p className="text-xs text-red-600 dark:text-yellow-400 leading-relaxed">
          ⚠️ Traffic Router redirects HTTPS requests from IDE tools (Antigravity, GitHub Copilot, Kiro) to your configured providers via local CA. May violate provider ToS → account ban. Use at your own risk.
        </p>
      </div>

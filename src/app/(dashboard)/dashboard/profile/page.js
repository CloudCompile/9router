...
export default function ProfilePage() {
  ...
  const handleExportDatabase = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `fusion-backup-${stamp}.json`;
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.fusion/db/data.sqlite</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="https://auth.example.com/application/o/fusion/"
              ...
              <form onSubmit={updateOutboundProxy} className="flex flex-col gap-4 pt-2 border-t border-border/50">
                ...
                <div className="flex flex-col gap-2 pt-2 border-t border-border/50">
                  ...
                  <Input
                    ...
                    disabled={loading || proxyLoading}
                  />
                  <p className="text-xs sm:text-sm text-text-muted">Comma-separated hostnames/domains to exclude from outbound routing.</p>
                </div>
